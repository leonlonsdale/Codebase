...
Big O notation is a mathematical concept used to analyse how an algorithm's performance changes as its input size grows. It describes the relationship between input size and a function’s execution time or memory usage.
